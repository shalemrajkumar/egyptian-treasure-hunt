...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\91628\\OneDrive - IIT Kanpur\\Desktop\\Extension\\serotonin_extension_lastrun.py',
...
image_18 = visual.ImageStim(
    ...
    ori=0.0, pos=(-0.4, 0), size=(0.32, 0.32),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
...
image_11 = visual.ImageStim(
    ...
    name='image_11', 
    image='sin', mask=None, anchor='center',
    ori=0.0, pos=[0,0], size=(0.08, 0.08),
    color=[1,1,1], colorSpace='rgb', opacity=None,
    flipHoriz=False, flipVert=False,
