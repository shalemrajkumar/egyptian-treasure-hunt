...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\91628\\Downloads\\Serotonin-test1_lastrun.py',
...
curse_img = "curse.png"
null_img = "null.png"
img_arr = [gold_img, zero_img, curse_img]
curr_sound = "null.wav"
...
sound_6 = sound.Sound('entry.wav', secs=-1, stereo=True, hamming=True,
    name='sound_6')
...
sound_4 = sound.Sound('bgm.wav', secs=-1, stereo=True, hamming=True,
    name='sound_4')
...
cases = ["cr", "pr", "cp", "pp"]
zero_img = "C:/Users/91628/Downloads/void.png"
gold_img = "C:/Users/91628/Downloads/gold.png"
curse_img = "C:/Users/91628/Downloads/curse.png"
null_img = "C:/Users/91628/Downloads/null.png"
img_arr = [gold_img, zero_img, curse_img]
curr_sound = "null.wav"
...
text_5 = visual.TextStim(win=win, name='text_5',
    text=score,
    font='Open Sans',
    pos=(0, 0.5), height=0.025, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    depth=-6.0);
...
sound_5 = sound.Sound('bgm.wav', secs=-1, stereo=True, hamming=True,
    name='sound_5')
...
for thisTrial in trials:
    ...
    text_6.setText(loop)
    # keep track of which components have finished
    trial_4Components = [image_17, image_18, image_19, text_4, text_6]
    ...
    while continueRoutine and routineTimer.getTime() < 3.0:
        ...
        if text_4.status == STARTED:  # only update if drawing
            text_4.setText(score, log=False)
    ...
    # keep track of which components have finished
    trial_2Components = [image_8, image_9, image_10, image_11, text_3]
    ...
    sound_3.setSound(curr_sound, secs=3, hamming=True)
    ...
    # keep track of which components have finished
    trial_3Components = [image_12, image_13, image_14, sound_3, image_15, text, image_29]
...
_key_resp_4_allKeys = []
# keep track of which components have finished
main_instructionsComponents = [image_7, key_resp_4, Instructions_Main_4, continu_4]
...
# set up handler to look after randomisation of conditions etc
trials_3 = data.TrialHandler(nReps=3.0, method='sequential', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
...
for thisTrial_3 in trials_3:
    ...
    routineForceEnded = False
    # update component parameters for each repeat
    sound_6.setSound('entry.wav', hamming=True)
    sound_6.setVolume(1.0, log=False)
    key_resp_7.keys = []
    key_resp_7.rt = []
    _key_resp_7_allKeys = []
    Instructions_Main_7.setText("Round"+str(rounds)+"/3")
...
key_resp_5.rt = []
_key_resp_5_allKeys = []
sound_4.setSound('bgm.wav', hamming=True)
...
for thisTrial_4 in trials_4:
    ...
    # keep track of which components have finished
    trial_6Components = [image_25, image_26, image_27, image_28, text_5]
...
key_resp_6.rt = []
_key_resp_6_allKeys = []
sound_5.setSound('bgm.wav', secs=60, hamming=True)
